...
* ⛵️ CURRENT PROJECT, Summer 2024 📍: TripTracker. Think of it as Strava for sailing. Tech stack: Native Android App in Java, with a .NET/C# backend hosted on Azure, data enrichment via Azure AI Stuido, and a React frontend. This is my master thesis project for my MAS Software Engineering degree.
